...
record = registry.read.get_asset_metadata(asset_id=753306745, source=MetadataSource.BOX)
...
header = registry.read.avm().arc89_get_metadata_header(asset_id=753306745)
page0 = registry.read.avm().arc89_get_metadata(asset_id=753306745, page=0)
