...
def asa_metadata_registry_client(
    ...
    factory = algorand_client.client.get_typed_app_factory(
        AsaMetadataRegistryFactory, default_sender=deployer.address
    )
...
def test_says_hello(asa_metadata_registry_client: AsaMetadataRegistryClient) -> None:
    result = asa_metadata_registry_client.send.hello(args=("World",))
...
def test_simulate_says_hello_with_correct_budget_consumed(
    ...
    result = (
        asa_metadata_registry_client.new_group()
        .hello(args=("World",))
        .hello(args=("Jane",))
        .simulate()
    )
