...
def test_get_metadata_mbr_delta_for_existing_metadata(
    ...
    to_smaller_mbr_delta = empty_metadata.get_mbr_delta(uploaded_short_metadata.size)
    ...
    to_larger_mbr_delta = maxed_metadata.get_mbr_delta(uploaded_short_metadata.size)
    mbr_delta = asa_metadata_registry_client.send.arc89_get_metadata_mbr_delta(
        args=Arc89GetMetadataMbrDeltaArgs(
            asset_id=uploaded_short_metadata.asset_id,
