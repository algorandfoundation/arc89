...
def test_constants() -> None:
    assert (
        const.HEADER_SIZE <= const.MAX_LOG_SIZE - const.ARC4_RETURN_PREFIX_SIZE
    )
    ...
    assert const.ARC89_CREATE_METADATA_FIXED_SIZE + const.FIRST_PAYLOAD_MAX_SIZE <= const.MAX_ARG_SIZE
    assert const.ARC89_EXTRA_PAYLOAD_FIXED_SIZE + const.EXTRA_PAYLOAD_MAX_SIZE <= const.MAX_ARG_SIZE
    assert const.ARC89_REPLACE_METADATA_SLICE_FIXED_SIZE + const.REPLACE_PAYLOAD_MAX_SIZE <= const.MAX_ARG_SIZE

    assert const.ARC89_GET_METADATA_RETURN_FIXED_SIZE + const.PAGE_SIZE <= const.MAX_LOG_SIZE
