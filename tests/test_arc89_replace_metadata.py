...
def test_replace_with_empty_metadata(
    ...
    replace_mbr_delta = empty_metadata.get_mbr_delta(old_size=uploaded_short_metadata.size)
...
def test_replace_with_smaller_metadata_size(
    ...
    replace_mbr_delta = short_metadata.get_mbr_delta(old_size=uploaded_maxed_metadata.size)
    mbr_delta = replace_metadata(
        asset_manager=asset_manager,
        asa_metadata_registry_client=asa_metadata_registry_client,
...
def test_replace_with_equal_metadata_size(
    ...
    replace_mbr_delta = maxed_metadata.get_mbr_delta(old_size=uploaded_maxed_metadata.size)
    mbr_delta = replace_metadata(
        asset_manager=asset_manager,
        asa_metadata_registry_client=asa_metadata_registry_client,
        asset_id=uploaded_maxed_metadata.asset_id,
